...
<h3><b>Rails_React_Hello_World</b></h3>
...
**Rails_React_Hello_World:** is a hello world project using rails and react.
...
```sh
  git clone https://github.com/prg-04/rails_react_hello_world.git
```
...
Feel free to check the [issues page](https://github.com/prg-04/rails_react_hello_world/issues).
